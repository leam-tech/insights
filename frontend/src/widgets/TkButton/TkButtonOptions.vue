...
<template>
	<div class="space-y-4">
		...
		<div>
			<span class="mb-2 block text-sm leading-4 text-gray-700">Button Value</span>
			<Autocomplete v-model="options.button_value" :returnValue="true" :options="valueOptions"/>
		</div>
	</div>
</template>
