...
<template>
	<div class="space-y-4">
		...
		<div>
			<span class="mb-2 block text-sm leading-4 text-gray-700">Max Distance</span>
			<Autocomplete v-model="options.max_distance" :returnValue="true" :options="valueOptions"/>
		</div>

		<div>
			<span class="mb-2 block text-sm leading-4 text-gray-700">Distance</span>
			<Autocomplete v-model="options.distance" :returnValue="true" :options="valueOptions"/>
		</div>
