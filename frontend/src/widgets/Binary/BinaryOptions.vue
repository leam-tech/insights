...
<template>
	<div class="space-y-4">
		...
		<div>
			<span class="mb-2 block text-sm leading-4 text-gray-700">Value</span>
			<Autocomplete v-model="options.value" :returnValue="true" :options="valueOptions"/>
		</div>

		<Color label="Color Truthy" v-model="options.colors"/>
		<Color label="Colors Falsy" v-model="options.colors_alternative"/>
